...
public class Grasshopper {
    ...
    public static int[] range = new int[]{100, 90, 80, 70, 60, 0};
    public static char[] grade = new char[]{'A', 'B', 'C', 'D', 'F'};
    public static char[] pool = new char[range[0] + 1];
    ...
    public static void main(String[] args) throws IOException {
        out.println(getGrade(70, 70, 100) + "");
