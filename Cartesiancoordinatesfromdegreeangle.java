...
public class Cartesiancoordinatesfromdegreeangle {
    ...
    public static Point2D coordinates(Double degrees, Double radius) {
        double deg= java.lang.Double.parseDouble(degrees.toString())/180D*PI;
        double rad= java.lang.Double.parseDouble(radius.toString());
        double x= java.lang.Double.parseDouble(String.format("%.10f",rad*cos(deg)));
        double y= java.lang.Double.parseDouble(String.format("%.10f",rad*sin(deg)));
