...
public class Meeting {
    ...
    public static String meeting(String s) {
        ...
        for (int i = 0; i < str.length; i++) {
            ...
            pair[i] = new Pair(at[0].toUpperCase(), at[1].toUpperCase());
        }
        Arrays.sort(pair);
        StringBuilder answer = new StringBuilder();
        for (int i = 0; i < str.length; i++) {
            answer.append("(" + pair[i].y + ", " + pair[i].x + ")");
        }
        return answer.toString();
    }

    public static void main(String[] args) throws IOException {
        String str = meeting("Alexis:Wahl;John:Bell;Victoria:Schwarz;Abba:Dorny;Grace:Meta;Ann:Arno;Madison:STAN;Alex:Cornwell;Lewis:Kern;Megan:Stan;Alex:Korn");
        debug(str);
        close.close();
    }
