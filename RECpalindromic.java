...
public class RECpalindromic {
    //    public class Main {
    static boolean palindromic(String str, int i, int h) {
        if (i > h) return true;
        if (str.charAt(i) == str.charAt(h - 1))
            return palindromic(str, i + 1, h - 1);
        return false;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        int h = str.length();
        out.println(palindromic(str, 0, h) + "");
        close.close();
    }
