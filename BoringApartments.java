...
//        public class Main {
    private static int countDigits(int size) {
        if (size > 3) return 1 + 2 + 3 + 4;
        if (size > 2) return 1 + 2 + 3;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int z = 0; z < till; z++) {
            ...
            int x = Integer.parseInt(String.valueOf(str.charAt(0)))-1;
            out.println((x*10+countDigits(str.length()))+"");
