...
//        public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        debug(negsum, neg, pos, possum, zero);
        if ((neg & 1) == 0) {
            out.println((negsum - neg + possum - pos + zero) + "");
        } else {
            if(zero>0){
            out.println((zero + negsum + possum - neg - pos) + "");
            }else {
                int zeroflip=2;
            out.println((zeroflip + negsum + possum - neg - pos) + "");
            }
