...
//            System.out.print("{ ");
            for (int j = 0; j < n; j++){
                if ((i & (1 << j)) > 0){
                    System.out.println(j+" "+Integer.toString(i&(1<<j),2));
                count++;
                }
                    System.out.println(j+" out "+Integer.toString(i&(1<<j),2));
            }
//            System.out.println('}');
        }
        return count;
