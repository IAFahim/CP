...
public class DinglemousePizza {
    //    public class Main {

    public static double howBiggaMaPizza(int blob, String crust) {
        if (crust.equals("crispy")) {
            return sqrt((blob * blob * blob) / 6);
        }
        return sqrt((blob * blob * blob) / 30);
    }
    ...
    // 11:28 PM Thu 01 2021 1/21/2021
}