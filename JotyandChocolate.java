...
//        public class Main {
    ...
    public static void main(String[] args) throws IOException {
        long n = sc.nextInt(), a = sc.nextInt(), b = sc.nextInt(), p = sc.nextInt(), q = sc.nextInt();
        long multiplyP = p * (n / a);
        long multiplyQ = q * (n / b);
        long same=(n/lcm(a,b))*Math.min(p,q);
        long answer=multiplyP+multiplyQ-same;
        out.println(answer+"");
        close.close();
    }
