...
public class CommonDenominators {
    ...
    public static String convertFrac(long[][] arr) {
        ...
        if (arr.length > 2) {
            ...
            if(arr[1][0]==1 || arr[1][0]==1){
                max=max(arr[1][0],arr[1][0]);
            }else {
                max = gcd(arr[0][0], arr[1][0]);
            }
            long l = lcm(arr[0][1], arr[1][1]);
    ...
    public static void main(String[] args) throws IOException {
        debug(convertFrac(new long[][]{{1, 2}, {1, 3}, {10, 40}}));
        close.close();
    }
