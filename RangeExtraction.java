...
//        public class Main {
    public static String rangeExtraction(int[] arr) {
        int end = arr[0], at = 0, count = 0;
        StringBuilder str = new StringBuilder();
        str.append(arr[0] + "");
        for (int i = 1; i < arr.length; i++) {
            count = 0;
            at = i;
            while (at < arr.length && end+1==arr[at]) {
                end = arr[at];
                at++;
                count++;
            }
    ...
    public static void main(String[] args) throws IOException {
        String str = rangeExtraction(new int[]{-6, -3, -2, -1, 0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 14, 15, 17, 18, 19, 20});
//        String str1 = rangeExtraction(new int[]{-3, -2, -1, 2, 10, 15, 16, 18, 19, 20});
        out.println(str);
        close.close();
    }
