...
public class searchLostNumber {
    //    public class Main {


    static int searchLostNumber(int[] arr) {
        int a=arr[0]-arr[1];
        int b=arr[1]-arr[2];
        int c=arr[2]-arr[3];
        debug(a,b,c);
    ...
    public static void main(String[] args) throws IOException {
        debug(searchLostNumber(new int[]{1, 3, 100, 7}));
        debug(searchLostNumber(new int[]{1, 100, 5, 7}));
        debug(searchLostNumber(new int[]{1, 3, 5, 7}));
    ...
    // 11:58 PM Thu 01 2021 1/21/2021
}