...
public class RemovedNumbers {
    ...
    public static List<long[]> removNb(long n) {
        ...
        for (long i = (n / 3); i < n / 2; i++) {
            long a = i, b = n, N = (n * (n + 1)) / 2;
            while (a <= b) {
                long leftSide = a + b + a * b;
                if (leftSide == N) {
                    answer.add(new long[]{a, b});
                    answer.add(new long[]{b, a});
                    return answer;
                }
                if (leftSide < n) {
                    a++;
    ...
    static Sc sc = new Sc();//sc throws Exception means it can crash like pro

    public static void main(String[] args) throws IOException {
        debugV2(removNb(100).size());
    }
