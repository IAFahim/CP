...
public class TrianglePartitioningA {
//        public class Main {
    public static void main(String[] args) throws IOException {
        int till=sc.nextInt();
        for (int z = 0; z < till; z++) {
            double ab=sc.nextDouble(),ac=sc.nextDouble(),bc=sc.nextDouble(),ade_bdec=sc.nextDouble();
            double ratio=ade_bdec/(ade_bdec+1);
            double ad=ab*sqrt(ratio);
            out.println("Case "+(z+1)+": "+ad);
        }
