    ...
    public static void main(String[] args) throws IOException {
        ...
        while (sc.hasNext()) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                int per_person = money / person;
                int loss = per_person * person;
                map.put(giver, map.get(giver) - loss);
                for (int j = 0; j < person; j++) {
                    String reseverer = sc.next();
                    map.put(reseverer, map.get(reseverer) + per_person);
                }
            }
            if (k > 0){
                out.println("");
