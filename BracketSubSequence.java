...
public class BracketSubSequence {
    //    public class Main {
    static int maxLength(String s, int n,int add) {
        int invalidOpenBraces = 0;
        int invalidCloseBraces = add;
        for (int i = 0; i < n; i++) {
            if (s.charAt(i) == '(') {
                invalidOpenBraces++;
            } else {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int z = 0; z < till; z++) {
            ...
            String st=str.substring(i);

            out.println(maxLength(st,st.length(),i) + "");
        }
    ...
    // 6:42 PM Tue 12 2020 12/29/2020
}