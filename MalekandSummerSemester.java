...
public class MalekandSummerSemester {
//        public class Main {

    public static void main(String[] args) throws IOException {
        int till=sc.nextInt();
        for (int z = 0; z < till; z++) {
            double n=sc.nextDouble(),persentage=sc.nextDouble();
            int needed=(int)Math.ceil(persentage*n),limit=49,count=0;
            for (int i = 0; i < n; i++) {
                int x=sc.nextInt();
                if(x>limit){
                    count++;
            ...
            out.println(count>=needed?"YES":"NO");
        }
        close.close();
    }
