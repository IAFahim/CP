...
public class grayscale {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File photoLocation = new File("C:\\Users\\Fahim\\IdeaProjects\\CP\\whoIsthis.jpg");
        BufferedImage bufferedImage = ImageIO.read(photoLocation);
        for (int y = 0; y < bufferedImage.getHeight(); y++) {
            for (int x = 0; x < bufferedImage.getWidth(); x++) {
                ...
                int avarage = (r + g + b) / 3;
                int modded = alpha << 24 | avarage << 16 | avarage << 8 | avarage;
                bufferedImage.setRGB(x, y, modded);
            }
        }
...
//        colorConvertOp.filter(bufferedImage, bufferedImage);
        File outfile = new File("C:\\Users\\Fahim\\IdeaProjects\\CP\\grayScaleVhia3.jpg");
