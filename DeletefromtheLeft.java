...
//        public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int count=arr.length+brr.length,a=arr.length,b=brr.length;
        ...
        out.println(count+"");
//        debug(arr,brr);
//        HashMap<Character,ArrayList<Integer>> linkchar=new HashMap<>();
//        HashSet<Character> total=new HashSet<>();
//        for (int i = 0; i < arr.length; i++) {
//            total.add(arr[i]);
//        }
//        for (char c :total) {
//            linkchar.put(c,new ArrayList<>());
//        }
//        for (int i = 0; i < arr.length; i++) {
//            linkchar.get(arr[i]).add(i);
//        }
//        for (char c : arr) {
//            ArrayList<Integer> current=linkchar.get(c);
//            for (int i = 0; i < current.size(); i++) {
//                out.print(current.get(i)+" ");
//            }
//            out.println("");
//        }
