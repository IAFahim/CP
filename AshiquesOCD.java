...
//        public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if(at+1==str.length || bt== str.length){
        ...
        for (int i = 0; i < str.length && str[i] == 'a'; i++) {
            count++;
        }
...
//            count++;
//        }
//        if (str.length >= count && at!=0 && bt==0 && str[at] == 'a') {
//            count++;
//        }
        int inb = 0;
        int blast = 0;
